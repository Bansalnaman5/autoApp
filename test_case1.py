...
x.click()
time.sleep(3)
# clicking to done button on post screen
rotate_image=driver.find_element_by_id("com.ATG.World:id/postImageRotateCollapsed")
rotate_image.click()
time.sleep(5)
done_pic_button=driver.find_element_by_id("com.ATG.World:id/button5")
print()
print("on pressing done button we are headed back to post options")
done_pic_button.click()
time.sleep(3)
...
# choosing post by camera and not by gallery
per=driver.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/androidx.appcompat.widget.LinearLayoutCompat/android.widget.FrameLayout/android.widget.ListView/android.widget.TextView[2]")
per.click()
time.sleep(3)
# allowing camera permission
# per_cam=driver.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/androidx.appcompat.widget.LinearLayoutCompat/android.widget.FrameLayout/android.widget.ListView/android.widget.TextView[2]")
...
rotate_image.click()
time.sleep(5)
cross=driver.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.ImageButton")
print("on pressing cross button the app crashes")
print()
cross.click()
time.sleep(100)